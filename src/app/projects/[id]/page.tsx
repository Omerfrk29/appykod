...
export default function ProjectDetailPage() {
  ...
  const gradients = [
    'from-primary via-info to-success',
    'from-success via-primary to-info',
    'from-danger via-warning to-primary',
  ];

  const gradient = gradients[parseInt(project.id) % gradients.length] || gradients[0];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              {project.fullDescription && (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="lg:col-span-2 bg-white dark:bg-gray-800 rounded-3xl p-8"
                >
        ...
        <section className="py-16 bg-gray-50 dark:bg-gray-900">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <Link
                href="/#contact"
                className={`inline-flex items-center px-8 py-4 rounded-full font-bold text-white bg-gradient-to-r ${gradient} hover:shadow-lg hover:scale-105 transition-all duration-300`}
              >
                {t('cta.button')}
              </Link>
            </motion.div>
