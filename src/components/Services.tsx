...
export default function Services({ services }: { services: Service[] }) {
  ...
  const displayServices = services.length > 0 ? services : [
    { id: '1', title: 'Web Development', description: 'Modern, responsive websites built with the latest technologies.', icon: 'globe' },
    { id: '2', title: 'Mobile Apps', description: 'Native and cross-platform mobile applications for iOS and Android.', icon: 'smartphone' },
    { id: '3', title: 'Custom Software', description: 'Tailored software solutions to meet your specific business needs.', icon: 'code' },
  ];

  const colorSchemes = [
    { iconBg: 'bg-primary/15 dark:bg-primary/25', iconColor: 'text-primary', borderGradient: 'from-primary via-info to-danger', glowColor: 'group-hover:shadow-[0_0_30px_rgba(94,111,234,0.3)]', accentColor: 'bg-info/20' },
    { iconBg: 'bg-success/15 dark:bg-success/25', iconColor: 'text-success', borderGradient: 'from-success via-primary to-info', glowColor: 'group-hover:shadow-[0_0_30px_rgba(71,207,134,0.3)]', accentColor: 'bg-primary/20' },
    { iconBg: 'bg-danger/15 dark:bg-danger/25', iconColor: 'text-danger', borderGradient: 'from-danger via-warning to-primary', glowColor: 'group-hover:shadow-[0_0_30px_rgba(255,75,123,0.3)]', accentColor: 'bg-warning/20' },
  ];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6" style={{ perspective: '1000px' }}>
          {displayServices.map((service, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`relative group bg-white dark:bg-gray-800 rounded-2xl md:rounded-3xl p-5 md:p-6 lg:p-8 transition-all duration-500 overflow-hidden shadow-xl hover:shadow-2xl h-full border border-gray-100 dark:border-gray-700 hover:-translate-y-2 hover:scale-[1.02] ${colorScheme.glowColor} cursor-pointer`}
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    >
                      ...
                      <div
                        className="absolute inset-0 bg-gradient-to-r from-transparent via-white/40 to-transparent animate-shimmer-hero"
